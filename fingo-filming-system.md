# fingo.digital — Filming System

One-minute Instagram Reels. No talking to camera. No performing. No filters.
Capture real work, real frustration, real milestones exactly as they happen.
...
- White sans-serif text, no background box. Instagram's native text tool or CapCut.
- Short emotional fragments, not technical descriptions.
- Place them when your body language changes — a pause, a slump, a sigh.

Examples:
- `add, commit, push...`
- `apparently just writing commit doesn't work`
- `day 4 of this animation`
- `why is it doing that`
- `oh wait`

### Colour

No filter. No grain. The Amsterdam light is the look.

- Highlights: −10 (softens monitor glow)
- Shadows: +5 (lifts pure black to dark charcoal)
- That's it.
